...
class Square:
    ...
    @property
    def position(self):
        """Property of the coodinates of this Square
        Raises:
    ...
    def position(self, value):
        ...
        Args: value as a tuple of two postive integers
        Raises:
            TypeError: if value is not a tuple or any in in tuple < 0
        """
